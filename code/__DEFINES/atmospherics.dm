...
#define SYNTH_PASSIVE_HEAT_GAIN 12 						 //Degrees C per handle_environment() Synths passively heat up. Mitigated by cooling efficiency. Can lead to overheating if not managed.
