...
#define NO_PUBLIC_LATHE	(1<<3)	//prevents the design from being auto-unlocked by public auto(y)lathes.
...
#define AUTOBOTTLER  	(1<<9) //Uses booze, for printing
#define AMMOLATHE		(1<<10) //For ammo and magazine production.
