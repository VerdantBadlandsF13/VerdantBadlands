...
#define RAD_BURN_THRESHOLD 800						// Applied radiation must be over this to burn

#define RAD_MOB_SAFE 250							// How much stored radiation in a mob with no ill effects
