...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_GMB = FREQ_GMB,
	RADIO_CHANNEL_DFS = FREQ_DFS,
	RADIO_CHANNEL_TOWN = FREQ_TWN
))
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_GMB]" = RADIO_CHANNEL_GMB,
	"[FREQ_DFS]" = RADIO_CHANNEL_DFS,
	"[FREQ_TWN]" = RADIO_CHANNEL_TOWN
))

GLOBAL_LIST_INIT(accesstoradio, list(
		"[ACCESS_DFS]" = list(RADIO_CHANNEL_DFS),
		"[ACCESS_GMB]" = list(RADIO_CHANNEL_GMB),
		"[ACCESS_VAULT]" = list(RADIO_CHANNEL_VAULT),
		"[ACCESS_TOWN]" = list(RADIO_CHANNEL_TOWN)
	))
