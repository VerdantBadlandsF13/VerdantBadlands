...
/obj/structure/catwalk
	...
	icon = 'icons/obj/smooth_structures/catwalk.dmi'
	icon_state = "catwalk"
	var/footstep = FOOTSTEP_CATWALK
	var/barefootstep = FOOTSTEP_CATWALK
	var/clawfootstep = FOOTSTEP_CATWALK
...
/obj/structure/catwalk/clockwork
	name = "cog lattice"
	desc = "A lightweight support lattice. These hold the Justicar's station together."
	icon = 'icons/obj/smooth_structures/lattice_clockwork.dmi'

/obj/structure/catwalk/clockwork/Initialize(mapload)
...
/obj/structure/catwalk/clockwork/ratvar_act()
	if(ISODD(x+y))
...
/obj/structure/catwalk/ratvar_act()
	new /obj/structure/catwalk/clockwork(loc)
