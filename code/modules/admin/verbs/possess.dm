/proc/possess(obj/O in world)
	...
	O.AddElement(/datum/element/weather_listener, /datum/weather/rad_storm, ZTRAIT_SURFACE, GLOB.rad_storm_sounds)
...
/proc/release()
	...
	usr.control_object.RemoveElement(/datum/element/weather_listener, /datum/weather/rad_storm, ZTRAIT_SURFACE, GLOB.rad_storm_sounds)
