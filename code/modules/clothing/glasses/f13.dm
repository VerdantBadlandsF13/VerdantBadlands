...
/obj/item/clothing/glasses/f13/sun
	name = "weathered shades"
	desc = "An old pair of sunglasses, manufactured well before the Great War. \
	They've long since lost any real ability to protect from more than sun glare."
	icon_state = "sun"
	item_state = "sun"
