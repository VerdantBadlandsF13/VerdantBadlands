...
/area/f13/wasteland
	...
	ambientsounds = BACKGROUND_AMBIENCE
	outdoors = 1
	open_space = 1
	blob_allowed = 0
	environment = 19
	...
	outdoors = TRUE
	lightswitch = FALSE
	flags_1 = NONE// No thanks, in regards to random stuff being generated.
...
/area/f13/wasteland/vt
	name = "VaultTec HQ Exterior"
	icon_state = "nanoex"
...
/area/f13/sewer
	name = "Sewer"
	icon_state = "sewer"
	ambientmusic =  list('sound/f13ambience/sewer.ogg')
	environment = 21
	grow_chance = 50
