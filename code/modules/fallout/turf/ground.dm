...
/turf/open/indestructible/ground
	...
	var/obj/effect/landmark/turfHazard = null
	var/obj/item/grenade/f13/mine/turfMines = null
...
#define VERMONT_PLANT_SPAWN_LIST	list(/obj/structure/flora/grass/wasteland = 10, /obj/effect/overlay/bl_turf/rocks = 5, /obj/structure/flora/wasteplant/bl/licorice = 5, /obj/structure/flora/wasteplant/bl/milkweed = 5, /obj/structure/flora/wasteplant/bl/yarrow = 5, /obj/structure/flora/wasteplant/bl/skullcap = 2)
