...
#define VERMONT_PLANT_SPAWN_LIST	list(/obj/structure/flora/grass/wasteland = 10, /obj/structure/flora/wasteplant/bl/licorice = 5, /obj/structure/flora/wasteplant/bl/milkweed = 5, /obj/structure/flora/wasteplant/bl/yarrow = 5, /obj/structure/flora/wasteplant/bl/skullcap = 2)
