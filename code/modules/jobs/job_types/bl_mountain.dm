/datum/job/gmb
	...
	enforces = "The GMB expects: Maintain relative peace and order within the outpost's area. <br> \
				...
				- Ensure a consistent food supply to your fellow militiamen and citizens. <br> \
...
/datum/job/gmb/commander
	...
	total_positions = 1
	spawn_positions = 1
	description = "The head of the Brattleboro GMB group. All members of the Brattleboro GMB answer directly to him."
	supervisors = "Morals."
...
/datum/job/gmb/walker
	...
	total_positions = 2
	spawn_positions = 2
	description = "A veteran Militiaman tasked with diplomacy, relations, retrieval and scouting as well as leading patrols. \
