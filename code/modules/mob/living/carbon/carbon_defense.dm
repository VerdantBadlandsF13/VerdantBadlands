...
/mob/living/carbon/attacked_by(obj/item/I, mob/living/user, attackchain_flags = NONE, damage_multiplier = 1, damage_bonus = 0)
...
/mob/living/carbon/soundbang_act(intensity = 1, stun_pwr = 20, damage_pwr = 5, deafen_pwr = 15)
	...
	if(effect_amount > 0)
		...
		if(istype(ears) && (deafen_pwr || damage_pwr))
			...
			SEND_SOUND(src, sound('modular_badlands/code/modules/rp_misc/sound/gore/contusion.ogg',0,1,0,250))
