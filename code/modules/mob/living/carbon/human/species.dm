...
/datum/species/proc/handle_digestion(mob/living/carbon/human/H)
	...
	switch(H.nutrition)
		if(NUTRITION_LEVEL_FULL to INFINITY)
			...
			H.throw_alert("nutrition", /obj/screen/alert/food/fat)
	...
	switch(H.water)
		...
		if(THIRST_LEVEL_MIDDLE to THIRST_LEVEL_LIGHT)
			...
			H.throw_alert("thirst", /obj/screen/alert/water/thirst1)
		if (THIRST_LEVEL_HARD to THIRST_LEVEL_MIDDLE)
			...
			H.throw_alert("thirst", /obj/screen/alert/water/thirst2)
