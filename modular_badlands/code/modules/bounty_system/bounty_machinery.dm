...
/obj/machinery/bounty_machine/proc/ShowUI()
	...
	var/datum/browser/popup = new(usr, "bounty", "Vault Fifty-Eight Contracts Database", 640, 400) // Set up the popup browser window
...
/obj/machinery/bounty_pod
	name = "Vault Bounty Pod"
	desc = "This is a Vault Bounty Pod"
