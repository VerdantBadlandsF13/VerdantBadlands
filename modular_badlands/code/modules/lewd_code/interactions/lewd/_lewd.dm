...
/mob/living/proc/cum(mob/living/partner, target_orifice)
	...
	if(gender == MALE)
		playlewdinteractionsound(loc, pick('modular_badlands/code/modules/lewd_code/interactions/sound/final_m1.ogg',
							'modular_badlands/code/modules/lewd_code/interactions/sound/final_m2.ogg',
							'modular_badlands/code/modules/lewd_code/interactions/sound/final_m3.ogg',
							'modular_badlands/code/modules/lewd_code/interactions/sound/final_m4.ogg',
							'modular_badlands/code/modules/lewd_code/interactions/sound/final_m5.ogg'), 90, 1, 0)//, pitch = get_age_pitch())
	else if(gender == FEMALE)
		playlewdinteractionsound(loc, pick('modular_badlands/code/modules/lewd_code/interactions/sound/final_f1.ogg',
							'modular_badlands/code/modules/lewd_code/interactions/sound/final_f2.ogg',
							'modular_badlands/code/modules/lewd_code/interactions/sound/final_f3.ogg'), 70, 1, 0)//, pitch = get_age_pitch())
	else
		playlewdinteractionsound(loc, pick('modular_badlands/code/modules/lewd_code/interactions/sound/final_f1.ogg',
							'modular_badlands/code/modules/lewd_code/interactions/sound/final_f2.ogg',
							'modular_badlands/code/modules/lewd_code/interactions/sound/final_f3.ogg'), 70, 1, 0)//, pitch = get_age_pitch())
...
/mob/living/proc/do_oral(mob/living/partner, fucktarget = "penis")
	...
	playlewdinteractionsound(get_turf(src), pick(	'modular_badlands/code/modules/lewd_code/interactions/sound/bj1.ogg',
									'modular_badlands/code/modules/lewd_code/interactions/sound/bj2.ogg',
									'modular_badlands/code/modules/lewd_code/interactions/sound/bj3.ogg',
									'modular_badlands/code/modules/lewd_code/interactions/sound/bj4.ogg',
									'modular_badlands/code/modules/lewd_code/interactions/sound/bj5.ogg',
									'modular_badlands/code/modules/lewd_code/interactions/sound/bj6.ogg',
									'modular_badlands/code/modules/lewd_code/interactions/sound/bj7.ogg',
									'modular_badlands/code/modules/lewd_code/interactions/sound/bj8.ogg',
									'modular_badlands/code/modules/lewd_code/interactions/sound/bj9.ogg',
									'modular_badlands/code/modules/lewd_code/interactions/sound/bj10.ogg',
									'modular_badlands/code/modules/lewd_code/interactions/sound/bj11.ogg'), 50, 1, -1)
...
/mob/living/proc/do_facefuck(mob/living/partner, fucktarget = "penis")
	...
	playlewdinteractionsound(loc, pick('modular_badlands/code/modules/lewd_code/interactions/sound/oral1.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/oral2.ogg'), 70, 1, -1)
	visible_message(message = "<font color=purple><b>\The [src]</b> [message]</font>", ignored_mobs = get_unconsenting())
...
/mob/living/proc/thigh_smother(mob/living/partner, fucktarget = "penis")
	...
	var file = pick('modular_badlands/code/modules/lewd_code/interactions/sound/bj10.ogg',
					'modular_badlands/code/modules/lewd_code/interactions/sound/bj3.ogg',
					'modular_badlands/code/modules/lewd_code/interactions/sound/foot_wet1.ogg',
					'modular_badlands/code/modules/lewd_code/interactions/sound/foot_dry3.ogg')
...
/mob/living/proc/nut_face(mob/living/partner)
	...
	/*playlewdinteractionsound(loc, pick('modular_badlands/code/modules/lewd_code/interactions/sound/nuts1.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/nuts2.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/nuts3.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/nuts4.ogg'), 70, 1, -1)*/ //These files don't even exist but nobody noticed because double-quotes were used instead of single.
	visible_message(message = "<font color=purple><b>\The [src]</b> [message]</font>", ignored_mobs = get_unconsenting())
...
/mob/living/proc/do_anal(mob/living/partner)
	...
	playlewdinteractionsound(loc, pick('modular_badlands/code/modules/lewd_code/interactions/sound/bang1.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/bang2.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/bang3.ogg'), 70, 1, -1)
	visible_message(message = "<font color=purple><b>\The [src]</b> [message]</font>", ignored_mobs = get_unconsenting())
...
/mob/living/proc/do_vaginal(mob/living/partner)
	...
	playlewdinteractionsound(loc, pick('modular_badlands/code/modules/lewd_code/interactions/sound/champ1.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/champ2.ogg'), 50, 1, -1)
	visible_message(message = "<font color=purple><b>\The [src]</b> [message]</font>", ignored_mobs = get_unconsenting())
...
/mob/living/proc/do_tribadism(mob/living/partner)
	...
	playlewdinteractionsound(loc, pick('modular_badlands/code/modules/lewd_code/interactions/sound/squelch1.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/squelch2.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/squelch3.ogg'), 70, 1, -1)
	visible_message(message = "<font color=purple><b>\The [src]</b> [message]</font>", ignored_mobs = get_unconsenting())
	partner.handle_post_sex(NORMAL_LUST, CUM_TARGET_VAGINA, src)
	handle_post_sex(NORMAL_LUST, null, partner)
	partner.dir = get_dir(partner,src)
...
/mob/living/proc/do_fingering(mob/living/partner)
	...
	playlewdinteractionsound(loc, 'modular_badlands/code/modules/lewd_code/interactions/sound/champ_fingering.ogg', 50, 1, -1)
	partner.handle_post_sex(NORMAL_LUST, null, src)
	partner.dir = get_dir(partner, src)
	do_fucking_animation(get_dir(src, partner))
...
/mob/living/proc/do_handjob(mob/living/partner)
	...
	playlewdinteractionsound(src, pick('modular_badlands/code/modules/lewd_code/interactions/sound/bang1.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/bang2.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/bang3.ogg'), 70, 1, -1)
	visible_message(message = "<font color=purple><b>\The [src]</b> [message]</font>", ignored_mobs = get_unconsenting())
...
/mob/living/proc/do_grindface(mob/living/partner)
	...
	playlewdinteractionsound(loc, pick('modular_badlands/code/modules/lewd_code/interactions/sound/foot_dry1.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/foot_dry2.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/foot_dry3.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/foot_dry4.ogg'), 70, 1, -1)
	visible_message(message = "<font color=purple><b>\The [src]</b> [message]</font>", ignored_mobs = get_unconsenting())
...
/mob/living/proc/do_grindmouth(mob/living/partner)
	...
	playlewdinteractionsound(loc, pick('modular_badlands/code/modules/lewd_code/interactions/sound/foot_wet1.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/foot_wet2.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/foot_wet3.ogg'), 70, 1, -1)
	visible_message(message = "<font color=purple><b>\The [src]</b> [message]</font>", ignored_mobs = get_unconsenting())
	partner.handle_post_sex(LOW_LUST, null, src)
	partner.dir = get_dir(src, partner)
	do_fucking_animation(get_dir(src, partner))
...
/mob/living/proc/do_footfuck(mob/living/partner)
	...
	playlewdinteractionsound(loc, pick('modular_badlands/code/modules/lewd_code/interactions/sound/foot_dry1.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/foot_dry3.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/foot_wet1.ogg',
						'modular_badlands/code/modules/lewd_code/interactions/sound/foot_wet2.ogg'), 70, 1, -1)
	visible_message(message = "<font color=purple><b>\The [src]</b> [message]</font>", ignored_mobs = get_unconsenting())
